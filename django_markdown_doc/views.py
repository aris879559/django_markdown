...
def document_detail(request, document_id):
    ...
    extras = ['fenced-code-blocks']  # Specify any additional features/extras here
    content_html = markdown2.markdown(document.content, extras=extras)
    return render(request, 'document_detail.html', {'document': document, 'content_html': content_html})
